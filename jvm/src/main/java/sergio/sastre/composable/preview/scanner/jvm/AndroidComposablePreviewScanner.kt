...
class AndroidComposablePreviewScanner() : ComposablePreviewScanner<AndroidPreviewInfo>(
    AndroidComposablePreviewFinder()
) {
    private object AndroidComposablePreviewFinder {
        operator fun invoke(): ClasspathPreviewsFinder<AndroidPreviewInfo> =
        ...
        private class AndroidComposablePreviewInfoMapper :
            ...
            ): AndroidPreviewInfo = AndroidPreviewInfo(
        ...
        private class AndroidPreviewMapperCreator :
            ComposablePreviewMapperCreator<AndroidPreviewInfo> {
