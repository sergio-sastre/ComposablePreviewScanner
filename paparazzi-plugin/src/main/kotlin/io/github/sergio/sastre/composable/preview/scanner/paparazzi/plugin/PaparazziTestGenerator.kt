...
class PaparazziTestGenerator {
    fun generateTestFileContent(
        packageName: String,
        className: String,
        packagesExpr: String,
        ...
        return """
            ...
            ${generateDimensionsClass()}

            ${generateScreenDimensionsObject()}

            ${generateDeviceConfigBuilderObject()}
            ...
            ${generateSnapshotHandlers()}

            ${generatePaparazziPreviewRuleObject()}
    ...
    private fun generateDimensionsClass(): String {
        return """
            class Dimensions(
    ...
    private fun generateScreenDimensionsObject(): String {
        return """
    ...
    private fun generateDeviceConfigBuilderObject(): String {
        return """
    ...
    private fun generateSnapshotHandlers(): String {
        return """
    ...
    private fun generatePaparazziPreviewRuleObject(): String {
        return """
    ...
    private fun generateComposableHelpers(): String {
        return """
            /**
